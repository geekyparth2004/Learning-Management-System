...
import { ArrowLeft, Plus, Trash2, Clock, Video, FileCode, GripVertical } from "lucide-react";
...
export default function CourseBuilderPage() {
    ...
    const [newItemType, setNewItemType] = useState<"VIDEO" | "ASSIGNMENT">("VIDEO");
                            ...
                            <div className="p-4 space-y-3">
                                ...
                                {activeModuleId === module.id ? (
                                    <div className="rounded border border-dashed border-gray-700 bg-[#1e1e1e] p-4 space-y-3">
                                        ...
                                        <input
                                            type="text"
                                            placeholder={newItemType === "VIDEO" ? "Video URL" : "Assignment ID (optional for now)"}
