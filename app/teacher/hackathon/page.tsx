...
import { Plus, Trash2, Calendar, Users, Trophy } from "lucide-react";
import { redirect } from "next/navigation";
import FormattedDate from "@/components/FormattedDate";

export default async function TeacherHackathonPage() {
    ...
    async function deleteContest(formData: FormData) {
        ...
        if (target.organizationId !== null) {
            throw new Error("Forbidden: this hackathon belongs to an organization");
        }
                ...
                <div className="space-y-4">
                    {contests.length === 0 ? (
                        <div className="flex flex-col items-center justify-center rounded-xl border border-gray-800 bg-[#161616] p-12 text-center text-gray-400">
                            ...
                            <p className="text-lg">No hackathons created yet.</p>
                            <Link href="/teacher/hackathon/create" className="mt-4 text-purple-400 hover:underline">
