                                                        ...
                                                        <div className="flex gap-1 items-center">
                                                            ...
                                                            <button
                                                                onClick={async () => {
                                                                    ...
                                                                    const toastId = "github-push";
                                                                    // Simple toast placeholder - in a real app use sonner/toast
                                                                    // For now, change text to "Saving..."
                                                                    const btn = document.getElementById("gh-push-btn");
                                                                    if (btn) btn.innerText = "Pushing...";

                                                                    try {
                                                                        const res = await fetch("/api/github/sync-web", {
                                                                            method: "POST",
                                                                            headers: { "Content-Type": "application/json" },
                                                                            body: JSON.stringify({
                                                                                files: webFiles,
                                                                                ...
                                                                                // Ensure 'order' exists on item, fallback to '0'
                                                                        ...
                                                                        setTimeout(() => { if (btn) btn.innerText = "Push to GitHub"; }, 2000);
                                                                    } catch (e) {
                                                                        console.error(e);
                                                                ...
                                                                id="gh-push-btn"
                                                                className="flex items-center gap-1.5 px-3 py-1 text-xs font-medium rounded bg-gray-800 text-white hover:bg-gray-700 transition-colors border border-gray-700 ml-1"
                                                            >
                                                                <svg height="14" viewBox="0 0 16 16" version="1.1" width="14" fill="currentColor" className="text-white">
