...
import { Mic, MicOff, Send, ArrowRight, Star, Loader2, ArrowLeft, Briefcase } from "lucide-react";
    ...
    if (!hasStarted) {
        return (
            <div className="flex min-h-screen flex-col items-center justify-center bg-[#0e0e0e] p-6 text-white">
                <div className="w-full max-w-2xl rounded-xl border border-gray-800 bg-[#161616] p-8 shadow-2xl">
                    <div className="mb-8 flex justify-center">
                        <div className="rounded-full bg-blue-900/20 p-4">
                            <Briefcase className="h-10 w-10 text-blue-400" />
                        </div>
                    </div>
                    <h1 className="mb-2 text-center text-3xl font-bold">Project Interview Setup</h1>
                    <p className="mb-8 text-center text-gray-400">
                        Tell us about your project so the AI can ask relevant questions.
                    </p>
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-gray-700 bg-[#0e0e0e] px-4 py-3 text-white placeholder-gray-500 focus:border-blue-500 focus:outline-none"
                            />
                        </div>
                        <div>
                            ...
                            <textarea
                                ...
                                placeholder="Describe what your project does, the technologies you used (React, Node.js, etc.), and your role."
                                className="h-40 w-full resize-none rounded-lg border border-gray-700 bg-[#0e0e0e] px-4 py-3 text-white placeholder-gray-500 focus:border-blue-500 focus:outline-none"
                            />
                        </div>
                        <button
            ...
            <div className="flex h-screen flex-col items-center justify-center bg-[#0e0e0e] text-white">
                <div className="max-w-md text-center">
                    ...
                    <p className="mb-8 text-gray-400">
                        You have successfully completed the project interview session. Great job explaining your work!
                    </p>
                    <Link
                        href="/interview"
        ...
        <div className="flex h-screen flex-col bg-[#0e0e0e] text-white">
            ...
            <div className="flex items-center justify-between border-b border-gray-800 bg-[#161616] px-6 py-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">Project Interview</h1>
                        <span className="text-sm text-gray-400">{projectTitle}</span>
                    </div>
                </div>
