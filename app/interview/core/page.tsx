...
const SUBJECTS = [
    { id: "os", name: "Operating Systems", icon: Cpu, color: "text-blue-500", bg: "bg-blue-500/10", border: "border-blue-500/20" },
    { id: "dbms", name: "DBMS", icon: Database, color: "text-green-500", bg: "bg-green-500/10", border: "border-green-500/20" },
    { id: "cn", name: "Computer Networks", icon: Network, color: "text-purple-500", bg: "bg-purple-500/10", border: "border-purple-500/20" },
    { id: "oop", name: "Object Oriented Programming", icon: Code2, color: "text-yellow-500", bg: "bg-yellow-500/10", border: "border-yellow-500/20" }
];

export default function CoreInterviewPage() {
    // Setup State
            ...
            <div className="flex min-h-screen flex-col items-center justify-center bg-[#0e0e0e] p-6 text-white">
                <div className="w-full max-w-4xl">
                    <div className="mb-12 text-center">
                        ...
                        <h1 className="mb-4 text-4xl font-bold">Core Subjects Interview</h1>
                        <p className="text-xl text-gray-400">
                            Select a subject to practice conceptual questions.
                        </p>
                    </div>
                        ...
                        {SUBJECTS.map((subject) => (
                            ...
                            >
                                ...
                                <div className="text-left">
                                    ...
                                    <p className="text-sm text-gray-400">Conceptual & Theoretical</p>
                                </div>
                                {selectedSubject === subject.name && (
                                    <div className="absolute right-4 top-1/2 -translate-y-1/2">
                                        <div className={`h-3 w-3 rounded-full bg-${subject.color.split('-')[1]}-500 shadow-[0_0_10px_currentColor]`} />
                                    </div>
                                )}
                            </button>
                        ))}
            ...
            <div className="flex h-screen flex-col items-center justify-center bg-[#0e0e0e] text-white">
                <div className="max-w-md text-center">
                    ...
                    <p className="mb-8 text-gray-400">
                        You have successfully completed the {selectedSubject} interview.
                    </p>
                    <Link
                        href="/interview"
        ...
        <div className="flex min-h-screen flex-col bg-[#0e0e0e] text-white">
            ...
            <div className="flex items-center justify-between border-b border-gray-800 bg-[#161616] px-6 py-4">
                ...
                <div className="flex flex-col items-center">
                    <span className="text-sm font-medium text-indigo-500">{selectedSubject} Round</span>
                    <div className="flex gap-1">
                        {Array.from({ length: 15 }).map((_, i) => (
                            <div
                                key={i}
                                className={`h-1 w-3 rounded-full ${i < questionCount ? "bg-indigo-500" : "bg-gray-800"
                                    }`}
                            />
                        ))}
                    </div>
                        ...
                        <div className="animate-in slide-in-from-bottom-8 duration-500">
                            <div className="rounded-2xl border border-gray-800 bg-[#161616] p-8 shadow-2xl">
                                ...
                                <button
                                    ...
                                    className="flex w-full items-center justify-center gap-3 rounded-xl bg-indigo-600 py-4 text-lg font-bold text-white transition-all hover:bg-indigo-500 hover:shadow-lg hover:shadow-indigo-900/20"
                                >
