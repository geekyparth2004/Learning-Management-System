...
import { Mic, MicOff, Send, ArrowRight, Star, Loader2, ArrowLeft, BookOpen, Database, Network, Cpu, Code } from "lucide-react";
...
const SUBJECTS = [
    { id: "OS", name: "Operating Systems", icon: Cpu, color: "text-blue-400", bg: "bg-blue-900/20" },
    { id: "DBMS", name: "DBMS", icon: Database, color: "text-green-400", bg: "bg-green-900/20" },
    { id: "CN", name: "Computer Networks", icon: Network, color: "text-purple-400", bg: "bg-purple-900/20" },
    { id: "OOP", name: "Object Oriented Programming", icon: Code, color: "text-yellow-400", bg: "bg-yellow-900/20" },
];
            ...
            <div className="flex min-h-screen flex-col items-center justify-center bg-[#0e0e0e] p-6 text-white">
                <div className="w-full max-w-4xl">
                    <div className="mb-12 text-center">
                        <h1 className="mb-4 text-4xl font-bold">Core Subject Interview</h1>
                        <p className="text-gray-400">Select a subject to begin your practice session.</p>
                    </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-2">
                        {SUBJECTS.map((subject) => (
                            <button
                                key={subject.id}
                                onClick={() => startInterview(subject.name)}
                            ...
                            >
                                <div className={`mb-4 inline-flex rounded-xl p-3 ${subject.bg}`}>
                                    <subject.icon className={`h-8 w-8 ${subject.color}`} />
                                </div>
                                <h3 className="mb-2 text-xl font-bold">{subject.name}</h3>
                                <p className="text-sm text-gray-500">
                                    Practice 15 questions ranging from definitions to deep concepts.
                                </p>
                            </button>
                        ))}
                    </div>
            ...
            <div className="flex h-screen flex-col items-center justify-center bg-[#0e0e0e] text-white">
                <div className="max-w-md text-center">
                    ...
                    <p className="mb-8 text-gray-400">
                        You have successfully completed the {selectedSubject} interview session.
                    </p>
                    <Link
                        href="/interview"
        ...
        <div className="flex h-screen flex-col bg-[#0e0e0e] text-white">
            ...
            <div className="flex items-center justify-between border-b border-gray-800 bg-[#161616] px-6 py-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">{selectedSubject} Interview</h1>
