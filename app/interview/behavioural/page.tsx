...
import { Mic, MicOff, Send, ArrowRight, Star, Loader2, ArrowLeft } from "lucide-react";
            ...
            <div className="flex h-screen flex-col items-center justify-center bg-[#0e0e0e] text-white">
                <div className="max-w-md text-center">
                    ...
                    <p className="mb-8 text-gray-400">
                        You have successfully completed the 15-question behavioural interview session. Great job!
                    </p>
                    <Link
                        href="/interview"
        ...
        <div className="flex h-screen flex-col bg-[#0e0e0e] text-white">
            ...
            <div className="flex items-center justify-between border-b border-gray-800 bg-[#161616] px-6 py-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-xl font-bold">Behavioural Interview</h1>
                        <span className="text-sm text-gray-400">AI HR Interviewer</span>
                    </div>
                </div>
