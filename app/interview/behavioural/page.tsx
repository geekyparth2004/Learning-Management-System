...
import { Mic, MicOff, ArrowRight, Star, Loader2, ArrowLeft, Users, Volume2 } from "lucide-react";
    ...
    if (!hasStarted) {
        return (
            <div className="flex min-h-screen flex-col items-center justify-center bg-[#0e0e0e] p-6 text-white">
                <div className="w-full max-w-md rounded-2xl border border-gray-800 bg-[#161616] p-8 text-center shadow-2xl">
                    <div className="mb-6 flex justify-center">
                        <div className="rounded-full bg-purple-900/20 p-4">
                            <Users className="h-10 w-10 text-purple-500" />
                        </div>
                    </div>
                    <h1 className="mb-2 text-3xl font-bold">Behavioural Interview</h1>
                    <p className="mb-8 text-gray-400">
                        Master HR rounds with 15 common behavioural questions.
                    </p>
                    <button
                        onClick={startInterview}
                        className="w-full rounded-xl bg-purple-600 py-4 font-bold text-white transition-transform hover:scale-[1.02] hover:bg-purple-500 active:scale-[0.98]"
                    >
                        Start Interview
                    </button>
                </div>
        ...
        return (
            <div className="flex h-screen flex-col items-center justify-center bg-[#0e0e0e] text-white">
                <div className="max-w-md text-center">
                    ...
                    <p className="mb-8 text-gray-400">
                        Great job practicing your behavioural skills.
                    </p>
                    <Link
                        href="/interview"
        ...
        <div className="flex min-h-screen flex-col bg-[#0e0e0e] text-white">
            ...
            <div className="flex items-center justify-between border-b border-gray-800 bg-[#161616] px-6 py-4">
                ...
                <div className="flex flex-col items-center">
                    <span className="text-sm font-medium text-purple-500">Behavioural Round</span>
                    <div className="flex gap-1">
                        {Array.from({ length: 15 }).map((_, i) => (
                            <div
                                key={i}
                                className={`h-1 w-3 rounded-full ${i < questionCount ? "bg-purple-500" : "bg-gray-800"
                                    }`}
                            />
                        ))}
                    </div>
                                ...
                                {isSpeaking ? (
                                    <div className="flex flex-col items-center gap-4">
                                        <div className="relative flex h-24 w-24 items-center justify-center rounded-full bg-purple-500/20">
                                            <Volume2 className="h-10 w-10 animate-pulse text-purple-400" />
                                            <div className="absolute inset-0 animate-ping rounded-full bg-purple-500/20"></div>
                                        </div>
                                        <p className="text-purple-400">Speaking question...</p>
                                    </div>
                                ) : (
                        ...
                        <div className="animate-in slide-in-from-bottom-8 duration-500">
                            <div className="rounded-2xl border border-gray-800 bg-[#161616] p-8 shadow-2xl">
                                <div className="mb-6 flex items-center justify-between">
                                    ...
                                    <div className="flex items-center gap-2 rounded-full bg-purple-900/20 px-4 py-2 text-purple-400">
                                ...
                                <button
                                    ...
                                    className="flex w-full items-center justify-center gap-3 rounded-xl bg-purple-600 py-4 text-lg font-bold text-white transition-all hover:bg-purple-500 hover:shadow-lg hover:shadow-purple-900/20"
                                >
