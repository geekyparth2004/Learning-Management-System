...
import { Mic, MicOff, Send, ArrowRight, Star, Loader2, ArrowLeft, Database, Search, Table, GitMerge } from "lucide-react";
...
const TOPICS = [
    { id: "basic", name: "Basic Queries", icon: Search, color: "text-blue-400", bg: "bg-blue-900/20" },
    { id: "joins", name: "Joins & Subqueries", icon: GitMerge, color: "text-green-400", bg: "bg-green-900/20" },
    { id: "advanced", name: "Advanced (Indexes/Window)", icon: Table, color: "text-purple-400", bg: "bg-purple-900/20" },
];
                        ...
                        {TOPICS.map((topic) => (
                            ...
                            >
                                ...
                                <p className="text-sm text-gray-500">
                                    Practice 15 questions on {topic.name}.
                                </p>
                            </button>
                        ))}
                    </div>
            ...
            <div className="flex h-screen flex-col items-center justify-center bg-[#0e0e0e] text-white">
                <div className="max-w-md text-center">
                    ...
                    <p className="mb-8 text-gray-400">
                        You have successfully completed the SQL interview session.
                    </p>
                    <Link
                        href="/interview"
            ...
            <div className="flex items-center justify-between border-b border-gray-800 bg-[#161616] px-6 py-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <span className="text-sm text-gray-400">SQL Concepts</span>
                    </div>
                </div>
